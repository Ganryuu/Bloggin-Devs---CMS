...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.post.index', compact('posts', 'setting'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.post.create', compact('categories', 'setting'));
    }
    ...
    public function edit(Post $post)
    {
        ...
        $categories = Category::orderBy('name', 'ASC')->pluck('name', 'id');
        return view('admin.post.edit', compact('categories', 'post', 'setting'));
    }
