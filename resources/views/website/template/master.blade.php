...
<body>
    ...
    <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">Bloggin Devs</a>
            ...
            <a href="login" class="btn btn-danger btn-sm  m-1 p-1" role="button">Login</a>

            <a href="register" class="btn btn-danger btn-sm m-1 p-1" role="button">Register</a>
        </div>
    </nav>
